...
export const metadata = {
  ...
  icons: {
    icon:
      "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><circle cx='50' cy='50' r='50' fill='%230d9488'/></svg>",
  },
};

export default function RootLayout({ children }) {
  return (
    <html lang={copy.metadata.lang} className={poppins.variable}>
      <head>
        <link rel="preconnect" href="https://connect.facebook.net" />
        <link rel="dns-prefetch" href="https://www.oriopay.app" />
